            ...
            <div class="col-lg-12">
              <div class="card" style="border-radius: 10px !important;">
                <div class="card-body row">
                  ...
                  <div class="col-3 d-flex justify-content-end align-items-center" style="font-size:30px; color:#0D6EFD; padding-right:40px">
          ...
          <div>
            <div class="col-lg-12">
              <div class="card" style="border-radius: 10px !important;">
                <div class="card-body row">
                  <div class="col-9">
                    <h5 class="card-title">Packed Item New</h5>
                  </div>
                  <div class="col-3 d-flex justify-content-end align-items-center" style="font-size:30px; color:#0D6EFD; padding-right:40px">
                    <a data-bs-toggle="modal" href="#exampleModalToggle" role="button"><i class="bi bi-pencil-square" style="color:#0D6EFD;"></i></a>
                  </div>
          ...
          <div>
            <div class="col-lg-12">
              <div class="card" style="border-radius: 10px !important;">
                <div class="card-body row">
                  <div class="col-9">
                    <h5 class="card-title">Wholesale Item</h5>
                  </div>
                  <div class="col-3 d-flex justify-content-end align-items-center" style="font-size:30px; color:#0D6EFD; padding-right:40px">
                    <a data-bs-toggle="modal" href="#exampleModalToggle" role="button"><i class="bi bi-pencil-square" style="color:#0D6EFD;"></i></a>
                  </div>
